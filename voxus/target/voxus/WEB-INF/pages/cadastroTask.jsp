				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<form:form method="POST" modelAttribute="userForm" id="userForm" name="userForm"
								class="form-signin">
								<h2 class="form-signin-heading">Crie um acesso</h2>
								...
								<spring:bind path="password">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<form:input type="password" path="password"
											class="form-control col-md-7 col-xs-12" placeholder="Senha"></form:input>
								...
								<spring:bind path="Perfil">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										 <form:select id="perfil" path="perfil" class="form-control" onchange="chargeHierarquia()">
										     <form:option value="" itemLabel="--- Perfil ---" label="--- Perfil ---"/>
										     <form:options items="${perfils}" itemValue="id" itemLabel="name"/>
										 </form:select>
								...
								<spring:bind path="User_id_hierarquia">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										 <form:select path="user_id_hierarquia" class="form-control" style="display:none">
											<form:option value="-1" label="--- Hierarquia ---" />
											<form:options items="${user_id_hierarquia}" itemValue="id" itemLabel="nome"/>
										</form:select>
								...
								<spring:bind path="Latitude">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										 <form:input type="text" path="latitude"
											class="form-control col-md-7 col-xs-12" placeholder="Latitude"
											autofocus="true" ></form:input>
								...
								<spring:bind path="Longitude">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										 <form:input type="text" path="longitude"
											class="form-control col-md-7 col-xs-12" placeholder="Longitude"
											autofocus="true"></form:input>
								...
								<spring:bind path="Telefone">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										 <form:input type="text" path="telefone"
											class="form-control col-md-7 col-xs-12" placeholder="Telefone"
											autofocus="true"></form:input>
								...
								<button class="btn btn-success" type="button" id="btnSubmit"
									...
									<input type="hidden" id="sucess" name="sucess" value="${sucess}"/>
							</form:form>
						</div>
					</div>
				</div>
...
function succes(){
	...
	swal({
		  ...
		  function () {
			  window.location = "${contextPath}/listaUsuarios";
		  },
